...
export default function Home() {
  ...
  const contractAddress = "0xbb85223474E3fAAf4C5fbAF71Ea55EE8e58F4e6f";
  ...
  useEffect(() => {
    ...
    if (ethereum) {
      const provider = new ethers.providers.Web3Provider(ethereum, "any");
      const signer = provider.getSigner();
      buyMeADonut = new ethers.Contract(contractAddress, contractABI, signer);
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy Jake a Donut!</title>
        <meta name="description" content="Tipping site" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Buy Jake a Donut!</h1>
        ...
        {currentAccount ? (
          <div>
            <form>
              ...
              <br />
              <div class="formgroup">
                <label>Send Jake a message</label>
                <br />

                <textarea
                  rows={3}
                  placeholder="Enjoy your donut!"
                  id="message"
              ...
              <div>
                <button type="button" onClick={buyDonut}>
                  Send 1 Donut for 0.001ETH
                </button>
              </div>
            </form>
          </div>
